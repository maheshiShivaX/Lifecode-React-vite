import '@/ComponentsCss/OurSmartPet.css';
import { OurSmartPetData } from '../../_Services/SatactData';
...
const OurSmartPet = () => {
    ...
    useEffect(() => {
        const GetProductBySlug = async () => {
            try {
                ...
                const response = await get(`${API_URL.productBySlug}/smart-tag-HvvBjN`);
    ...
    return (
        <>
            <section className='our-smart-pet'>
                <div className="container">
                    <div className='privacy_security_inner'>
                        <div className='sprivacy_security_hedding'>
                            {/* <p data-aos="fade-up" data-aos-delay="800">{OurSmartPetData?.title}</p> */}
                            <h2 data-aos="fade-down" data-aos-delay="400">{OurSmartPetData?.hedding}</h2>
                        </div>
                        <div className="row">
                            <div className="col-lg-7 col-md-6 col-sm-12">
                                <div className='privacy_security_content_box' data-aos="fade-up-left" data-aos-delay="400">
                                    {OurSmartPetData?.childMenu?.map((item, index) => (
                                ...
                                <div className='privacy_security_btn'>
                                    <button className='active hover-effect' onClick={onProductDetail}>{OurSmartPetData?.shopNow}</button>
                                    <a href="https://www.amazon.in/dp/B0DCT42R9G" target='_blank' className='hover-effect'>{OurSmartPetData?.order}
                                        <img src={OurSmartPetData?.imageAmezon} alt="" />
                            ...
                            <div className="col-lg-5 col-md-6 col-sm-12" data-aos="fade-up-right" data-aos-delay="800">
                                <div className='privacy_security_image our-smart-pet-image'>
                                    <img src={OurSmartPetData?.image} alt="" />
                                </div>
                            </div>
